                                ...
                                <div class="slider-active owl-carousel">
                                    ...
                                    <div class="single-slide align-center-left  animation-style-01 bg-1">
                                        ...
                                        <div class="slider-content">
                                            <h5>Dijual Murah <span>-20% Off</span> Minggu Ini</h5>
                                            <h2>Chamcham Galaxy S9 | S9+</h2>
                                            <h3>Mulai Dari <span>Rp 12.000.000,-</span></h3>
                                    ...
                                    <div class="single-slide align-center-left animation-style-02 bg-2">
                                        <div class="slider-progress"></div>
                                        <div class="slider-content">
                                            <h5>Dijual Murah <span>Black Friday</span> Minggu Ini</h5>
                                            <h2>Work Desk Surface Studio 2018</h2>
                                            <h3>Mulai Dari <span>Rp 14.000.000,-</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="belanja.php">Belanja Sekarang</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-slide align-center-left animation-style-01 bg-3">
                                        <div class="slider-progress"></div>
                                        <div class="slider-content">
                                            <h5>Dijual Murah <span>-10% Off</span> Minggu Ini</h5>
                                            <h2>Phantom 4 Pro+ Obsidian</h2>
                                            <h3>Mulai Dari <span>Rp 15.000.000,-</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="belanja.php">Belanja Sekarang</a>
                                            </div>
                                        </div>
